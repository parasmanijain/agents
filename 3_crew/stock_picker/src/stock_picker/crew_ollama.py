...
from .tools.serper_wrapper import SerperWrapperTool
...
class StockPicker:
    ...
    def crew(self) -> Crew:
        ...
        manager = Agent(
            ...
            instructions="""
CRITICAL TOOL RULES:
- When calling any tool, pass ONLY raw values.
- If a tool field expects a string, pass a plain string.
- Never pass schema objects like {"description": "...", "type": "str"}.

Delegate work to coworker must be called like:
{"coworker":"Stock Picker from Research","task":"<plain string>","context":"<plain string>"}
""",
        )
